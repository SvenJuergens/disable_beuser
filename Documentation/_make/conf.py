# -*- coding: utf-8 -*-
#
# Disable BeUser Task documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 09 Sep 2015 10:43:51 +0200.
#
...
htmlhelp_basename = 'disable_beuserdoc'
...
latex_documents = [
    ('Index', 'disable_beuser.tex', u'Disable BeUser Task',
     u'', 'manual'),
]
...
pdf_documents = [
    ('Index', 'disable_beuser', u'Disable BeUser Task',
     u''),
]
...
texinfo_documents = [
    ('Index', 'disable_beuser', u'Disable BeUser Task',
     u'', 'Disable BeUser Task', 'One line description of project.',
     'Miscellaneous'),
]
